"""
    REINFORCE with Continous Action Parameterization 
"""

import numpy as np
import gymnasium as gym

from .reinforce import PolicyBase, REINFORCE

class NormalApproximator(PolicyBase):
    def __init__(self, initial_miu, initial_sigma):
        self.initial_miu = initial_miu
...
class REINFORCEContinous(REINFORCE):
