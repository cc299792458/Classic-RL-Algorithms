...
Value Iteration is more efficient than Policy Iteration. In this experiment, it solved the problem in approximately $\frac{1}{30}$ of the time required by Policy Iteration.
