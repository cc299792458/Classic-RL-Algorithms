"""
    Use Sarsa to solve Wendy Grid World with Stochastic Wind
"""
...
from envs.grid_world import WindyGridWorldStochastic, animate_trajectory
...
if __name__ == '__main__':
    ...
    env = WindyGridWorldStochastic(max_episode_length=False)
